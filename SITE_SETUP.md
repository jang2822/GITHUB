...
- 운영자·문의 이메일, 실제 요청 권한, 외부 서비스 데이터 흐름, 보관·삭제 기준은 운영자 확인 후 확정합니다.
...
주소는 Pages 배포가 성공한 후에 사용할 수 있습니다. 검토용 초안이므로 연락처 및 실제 처리방식 확정 전에는 Google Cloud의 최종 제출 주소로 사용하지 마세요.
